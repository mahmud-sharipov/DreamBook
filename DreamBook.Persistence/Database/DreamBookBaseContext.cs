...
public abstract class DreamBookBaseContext : IdentityDbContext<User, Role, Guid>, IContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(DreamConfiguration).Assembly);
    }
